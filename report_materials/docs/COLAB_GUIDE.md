...
MyDrive/BookLog/scripts/prepare_data.py
```

File `prepare_data.py` nằm trong thư mục `scripts/` của dự án này.
...
```python
!python "/content/drive/MyDrive/BookLog/scripts/prepare_data.py" \
